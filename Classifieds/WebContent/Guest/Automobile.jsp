...
String sql = "SELECT up.*,sc.*,u.*,l.*,c.* FROM user_product up, subcategory sc, user u,location l, category c  where up.subCategory_id=sc.id and up.user_id=u.id and u.location_id=l.id and sc.category_id =c.id and c.name='AutoMobile'";
