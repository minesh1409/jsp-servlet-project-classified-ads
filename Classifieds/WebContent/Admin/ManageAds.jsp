...
<div class="inner-box">
<h2 class="title-2"><i class="icon-docs"></i> Manage Ads </h2>
...
<!-- </div> -->
<!-- </td> -->
<td style="width:14%" class="add-img-td"><a href="#"><img class="thumbnail  img-responsive" src="../img/<%=resultSet.getString(5)%>" alt="img"></a></td>
