...
<div class="radio">
<label>
<input type="radio" name="Usertype" id="optionsRadios<%=resultSet.getInt(1)%>" value="<%=resultSet.getInt(1)%>" checked>
...
<div class="col-md-6">
<input name="FirstName" placeholder="First Name" class="form-control input-md"  type="text" required pattern="[A-Za-z]+" required="" >  <!--  name changed  -->
</div>
</div>
...
<div class="col-md-6">
<input name="LastName" placeholder="Last Name" class="form-control input-md" type="text" required pattern="[A-Za-z]+" required="" >  <!--  name changed  -->
</div>
</div>
...
<div class="col-md-6">
<input name="Contact" placeholder="Phone Number" class="form-control input-md" type="number" required>  <!--  name changed number type pattern="\d+" or pattern="[0-9]+"or type="number" -->
<div class="checkbox">
<label>
...
<label class="col-md-4 control-label" for="textarea">Address<sup>*</sup></label> 
 <div class="col-md-6"> 
<textarea class="form-control" id="textarea" name="Address" placeholder="Address" required></textarea>  <!--  name changed  --> 
</div>
</div>
...
<div class="col-md-6">
<input name="Email" type="email" class="form-control" id="inputEmail3" placeholder="Email" required >  <!--  name field edit changed  -->
</div>
</div>
...
<div class="col-md-6">
<input name="Password" type="password" class="form-control" id="inputPassword3" placeholder="Password" required >  <!--  name changed  -->
...
<input name="checkboxes" id="checkboxes-1" value="1" type="checkbox" required="">I have read and agree to the <a href="Terms&Condition.jsp">Terms & Conditions</a>
</label>
</div>
